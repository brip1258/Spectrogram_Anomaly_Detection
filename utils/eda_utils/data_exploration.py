...
def unique_label_counts(label_array: np.array) -> None:
    """
    This will print out the counts of the number of unique labels 

    
    Args:
        label_array (numpy array):array of labels
    """
    newer = {}
    ...
    # Print each label and its count in a formatted way
    print("Label Counts:")
    for label, count in newer.items():
        print(f"{label}: {count}")